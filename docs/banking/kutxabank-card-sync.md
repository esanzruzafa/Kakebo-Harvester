...
4. Elegir una de las seis opciones del banco para el periodo. Kakebo pulsa esa opción en la ventana bancaria; solo **Entre fechas** solicita las fechas concretas. Pulsar **Sincronizar tarjetas marcadas**. Si el banco solicita autorización adicional, completarla en su ventana y volver a intentar la sincronización.
...
- El titular confirmó una sincronización completa de **Entre fechas** en el portable con la pulsación real del radio. Las otras cinco opciones y el nuevo catálogo requieren una prueba real con el paquete actualizado.
